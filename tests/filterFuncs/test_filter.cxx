...
TEST_CASE("Test filter function", "[filter]") {
  ...
  SECTION("Empty denom") {
    ...
    CHECK_THAT(filter(nom, denom, inputs), Equals(std::vector<double>()));
  }
  ...
  SECTION("Empty nom") {
    ...
    CHECK_THAT(filter(nom, denom, inputs), Equals(std::vector<double>(inputs.size(), 0.0)));
  }
  ...
  SECTION("Identity") {
    ...
    CHECK_THAT(filter(nom, denom, inputs), Equals(inputs));
  }
  ...
  SECTION("Times 2") {
    ...
    CHECK_THAT(filter(nom, denom, inputs), Equals(myFuncs::scaleVector(inputs, 2.0)));
  }
  ...
  SECTION("Times 0.5") {
    ...
    CHECK_THAT(filter(nom, denom, inputs), Equals(myFuncs::scaleVector(inputs, 0.5)));
  }
  ...
  SECTION("Test1") {
    ...
    const auto filtered = filter(nom, denom, inputs);
