...
std::vector<double> realSequence2psd(const std::vector<double>& input, const double sampleingFrequency) {
	...
	//We do this by multiplying all their corresponding frequencies by 2.
	//The DC component and the Nyquist component for N odd are never "dropped", so we don't multiply them by 2.
