...
RunDB::RunDB():
m_DB({ 
{ 566, RunParams(566, Crystal::CsI_Tl_Belle, -1.0,58, 0.0, 0.0, 0.085 ) },
{ 567, RunParams(567, Crystal::CsI_Tl_Belle, -1.0,58, 300, 300, 0.085 ) },
{ 568, RunParams(568, Crystal::CsI_Tl_Belle, -1.0,58, 300, 300, 0.085 ) },
...
{ 572, RunParams(572, Crystal::CsI_Tl_Belle, -1.0,58, 300, 300, 0.087 ) },
...
{ 577, RunParams(577, Crystal::CsI_Tl_Belle, 31.0,58, 300, 300, 0.087 ) },
...
{ 580, RunParams(580, Crystal::CsI_Tl_Belle, 6.0,58, 300, 300, 0.087 ) },
{ 584, RunParams(584, Crystal::CsI_Tl_Belle, 3.0,58, 0.0, 0.0, 0.087 ) },
{ 585, RunParams(585, Crystal::CsI_Tl_Belle, 3.0,58, 300, 300, 0.087 ) },
...
{ 589, RunParams(589, Crystal::CsI_Tl_Belle, 0.5,58, 300, 300, 0.087 ) },
{ 591, RunParams(591, Crystal::CsI_Tl_Belle, 0.5,58, -140, -165.8021138, 0.087 ) },
{ 592, RunParams(592, Crystal::CsI_Tl_Belle, 3.0,58, 300, 300, 0.087 ) },
{ 593, RunParams(593, Crystal::CsI_Tl_Belle, 6.0,58, 300, 300, 0.087 ) },
{ 594, RunParams(594, Crystal::CsI_Tl_Belle, 31.0,58, 300, 300, 0.087 ) },
{ 595, RunParams(595, Crystal::CsI_Tl_Belle, 31.0,58, -140, -165.8021138, 0.087 ) },
{ 596, RunParams(596, Crystal::CsI_Tl_Belle, -1.0,58, 300, 300, 0.087 ) },
...
{ 628, RunParams(628, Crystal::CsI_Chinese, -1.0,458, 300, 300, 0.082 ) },
{ 629, RunParams(629, Crystal::CsI_Chinese, -1.0,458, 300, 300, 0.082 ) },
{ 630, RunParams(630, Crystal::CsI_Chinese, 31.0,458, 0.0, 0.0, 0.082 ) },
{ 631, RunParams(631, Crystal::CsI_Chinese, 31.0,458, 300, 300, 0.082 ) },
...
{ 638, RunParams(638, Crystal::CsI_Chinese, 6.0,458, 300, 300, 0.082 ) },
{ 641, RunParams(641, Crystal::CsI_Chinese, 6.0,458, 300, 300, 0.082 ) },
{ 642, RunParams(642, Crystal::CsI_Chinese, 3.0,458, 0.0, 0.0, 0.082 ) },
{ 643, RunParams(643, Crystal::CsI_Chinese, 3.0,458, 300, 300, 0.082 ) },
{ 646, RunParams(646, Crystal::CsI_Chinese, 3.0,458, 300, 300, 0.082 ) },
...
{ 654, RunParams(654, Crystal::CsI_Chinese, 0.5,458, 300, 300, 0.082 ) },
...
{ 676, RunParams(676, Crystal::CsI_Tl_Babar, -1.0,458, 300, 300, 0.0835 ) },
...
{ 679, RunParams(679, Crystal::CsI_Tl_Babar, 31.0,458, 300, 300, 0.0835 ) },
{ 680, RunParams(680, Crystal::CsI_Tl_Babar, 6.0,458, 0.0, 0.0, 0.0835 ) },
{ 681, RunParams(681, Crystal::CsI_Tl_Babar, 6.0,458, 300, 300, 0.0835 ) },
...
{ 685, RunParams(685, Crystal::CsI_Tl_Babar, 3.0,458, 300, 300, 0.0835 ) },
{ 686, RunParams(686, Crystal::CsI_Tl_Babar, 3.0,458, 300, 300, 0.0835 ) },
{ 688, RunParams(688, Crystal::CsI_Tl_Babar, 0.5,458, 300, 300, 0.0835 ) },
...
{ 707, RunParams(707, Crystal::CsI_Tl_Babar, -1.0,458, 300, 300, 0.0835 ) },
{ 712, RunParams(712, Crystal::CsI_Ukrainian, -1.0,458, 300, 300, 0.085 ) },
...
{ 717, RunParams(717, Crystal::CsI_Ukrainian, 31.0,458, 300, 300, 0.085 ) },
...
{ 723, RunParams(723, Crystal::CsI_Ukrainian, 6.0,458, 300, 300, 0.085 ) },
{ 724, RunParams(724, Crystal::CsI_Ukrainian, 3.0,458, 300, 300, 0.085 ) },
...
{ 730, RunParams(730, Crystal::CsI_Ukrainian, 0.5,458, 300, 300, 0.085 ) },
{ 731, RunParams(731, Crystal::CsI_Ukrainian, 0.5,458, -140, -165.8021138, 0.085 ) },
{ 732, RunParams(732, Crystal::CsI_Ukrainian, 31.0,458, 300, 300, 0.085 ) },
...
{ 739, RunParams(739, Crystal::CsI_Ukrainian, 31.0,458, 300, 300, 0.085 ) },
{ 743, RunParams(743, Crystal::CsI_Ukrainian, -1.0,458, 0.0, 0.0, 0.085 ) },
{ 746, RunParams(746, Crystal::CsI_Tl_Belle, -1.0,58, 300, 300, 0.086 ) },
{ 747, RunParams(747, Crystal::CsI_Tl_Belle, 31.0,58, 300, 300, 0.086 ) },
{ 748, RunParams(748, Crystal::CsI_Tl_Belle, 6.0,58, 300, 300, 0.086 ) },
{ 751, RunParams(751, Crystal::CsI_Tl_Belle, 3.0,58, 300, 300, 0.086 ) },
{ 752, RunParams(752, Crystal::CsI_Tl_Belle, 0.5,58, 300, 300, 0.086 ) },
{ 754, RunParams(754, Crystal::CsI_Chinese, -1.0,458, 0.0, 0.0, 0.092 ) },
{ 755, RunParams(755, Crystal::CsI_Chinese, 3.0,458, 300, 300, 0.092 ) }
}//unordered_map
)//initialization list
{ }//constructor
