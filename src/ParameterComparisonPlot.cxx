...
ParameterComparisonPlot::ParameterComparisonPlot() : TGraphErrors(), m_drawValueLabels(true) {}
...
void ParameterComparisonPlot::drawYaxisLabels(const double textLabelSize) {
  // Couldn't get this to work with this->GetYaxis()->ChangeLabel() because root would add/remove labels depending on the number
  // of points
